                ...
                <div class="row gutters">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="row gutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div class="card">
                                    <form action="{{ url('admin/facility/update', $facility->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="card-body">
                                            <div class="form-group row gutters">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="kode_fasilitas" value="{{ $facility->kode_fasilitas }}" class="form-control" placeholder="Judul Fasilitas" required>
                                                </div>
                                            </div>    
                                            <div class="form-group row gutters">
                                                <label for="inputEmail3" class="col-sm-3 col-form-label">Nama Fasilitas</label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="nama_fasilitas" value="{{ $facility->nama_fasilitas }}" class="form-control" placeholder="Judul Fasilitas" required>
                                                </div>
                                            </div>                                            
                                            <div class="form-group row gutters">
                                                ...
                                                <div class="col-sm-9">
                                                    <select name="status" id="" class="form-control">
                                                        <option value="{{ $facility->status }}">
                                                            <?php if ($facility->status == 0) {
                                                                echo "Tidak Aktif";
                                                            } else {
                                                                echo "Aktif";
                                                            } ?>
