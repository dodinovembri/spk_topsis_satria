...
--
-- Host: localhost:3306
-- Generation Time: Jul 15, 2021 at 08:56 PM
...
INSERT INTO `alternatif` (`id`, `id_kategori`, `kode_alternatif`, `nama_alternatif`, `latitude`, `longitude`, `gambar`, `gambar_panorama`, `keterangan`) VALUES
...
INSERT INTO `gallery` (`gambar`, `id_alternatif`, `status`) VALUES
('60eaa8abe59b1.jpg', 1, 1),
('60eaa8fc60abd.jpg', 1, 1);
...
INSERT INTO `kategori` (`id`, `kode_kategori`, `nama_kategori`, `gambar`, `keterangan`) VALUES
...
ALTER TABLE `alternatif`
  ADD PRIMARY KEY (`id`),
  ADD KEY `id_jenis_alternatif` (`id_kategori`);
...
--
ALTER TABLE `alternatif`
  ADD CONSTRAINT `alternatif_ibfk_1` FOREIGN KEY (`id_kategori`) REFERENCES `kategori` (`id`);

--
-- Constraints for table `gallery`
--
ALTER TABLE `gallery`
  ADD CONSTRAINT `gallery_ibfk_1` FOREIGN KEY (`id_alternatif`) REFERENCES `alternatif` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `nilai_alternatif`
  ...
  ADD CONSTRAINT `nilai_alternatif_ibfk_2` FOREIGN KEY (`id_kriteria`) REFERENCES `kriteria` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `nilai_alternatif_ibfk_3` FOREIGN KEY (`id_nilai_kriteria`) REFERENCES `nilai_kriteria` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
